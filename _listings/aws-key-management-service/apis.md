...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/schedules/master/_listings/aws-key-management-service/apis.md
...
- name: AWS Key Management Service API - Schedule Key Deletion
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/schedules/master/_listings/aws-key-management-service/actionschedulekeydeletion-get-openapi.md
- name: AWS Key Management Service API - Schedule Key Deletion
  x-api-slug: actionschedulekeydeletion-get
  description: Schedules the deletion of a customer master key (CMK).
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-key-management.jpg
