...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/schedules/master/_listings/aws-device-farm/apis.md
...
- name: AWS Device Farm API - Schedule Run
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/schedules/master/_listings/aws-device-farm/actionschedulerun-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/schedules/master/_listings/aws-device-farm/actionschedulerun-get-openapi.md
- name: AWS Device Farm API - Schedule Run
  x-api-slug: actionschedulerun-get
  description: Schedules a run.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Mobile-Services_AWSDeviceFarm.png
